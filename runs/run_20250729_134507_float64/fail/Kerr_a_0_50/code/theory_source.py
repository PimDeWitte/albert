...
class Kerr(GravitationalTheory):
    ...
    def __init__(self, a: float = 0.5):
        ...
        # <reason>chain: For non-rotating Kerr (a=0), it's identical to Schwarzschild and uses 4D solver</reason>
        # <reason>chain: For rotating Kerr (a≠0), it has g_tp≠0 and needs the 6D general solver</reason>
