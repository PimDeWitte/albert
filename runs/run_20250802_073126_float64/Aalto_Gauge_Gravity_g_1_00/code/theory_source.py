"""
Aalto gauge gravity theory with unitary symmetries.
Based on https://aaltodoc.aalto.fi/items/a2fbfa61-7480-437b-ab12-9773d8070a98

This approach treats gravity as a gauge theory with unitary symmetries,
focusing on renormalizability through gauge structure. Uses SU(N) gauge
groups extended to include gravitational interactions.
"""
