"""
Analog Gravity in Superfluids Theory

A theory that models gravitational phenomena through superfluid dynamics.
Acoustic perturbations in the superfluid act as analogs to fields propagating
in curved spacetime, with the superfluid flow velocity playing the role of
the spacetime metric.

Key principles:
1. Phonons in superfluid = massless fields in curved spacetime
2. Superfluid flow creates effective metric for sound waves
3. Quantum vortices = topological defects analogous to cosmic strings

<reason>chain: Tests gravity-fluid correspondence and emergent spacetime from condensed matter</reason>
"""
...
from physics_agent.constants import GRAVITATIONAL_CONSTANT, SPEED_OF_LIGHT, PLANCK_CONSTANT
...
AnalogGravitySuperfluid.sweep = {
    'sound_speed': [0.001, 0.01, 0.1],  # Fraction of light speed
    'healing_length': [1e-12, 1e-10, 1e-8],  # Meters
    'vortex_density': [0.0, 1e10, 1e12],  # Vortices per m²
}

# Preferred parameters based on superfluid helium
AnalogGravitySuperfluid.preferred_params = {
    'sound_speed': 0.01,  # ~3000 m/s for superfluid helium
    'healing_length': 1e-10,  # ~1 Angstrom
    'vortex_density': 0.0,  # No vortices initially
}
