"""
Causal Dynamical Triangulations (CDT) approach to quantum gravity.
Based on https://arxiv.org/abs/1110.6875

CDT is a non-perturbative lattice approach that constructs spacetime from
elementary simplices while respecting causality. The path integral sums over
causal triangulations to derive emergent spacetime geometry.
"""
