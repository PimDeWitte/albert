...
class AlenaTensor(GravitationalTheory, QuantumMixin):
    """
    ...
    def __init__(self, gamma: float = 0.0):
        ...
        lagrangian = get_symbol('R') + gamma * get_symbol('R_μν') * get_symbol('R^μν')
        
        super().__init__(
            f"Alena‑Tensor‑γ={gamma:+.2f}",  # Include parameter in name
