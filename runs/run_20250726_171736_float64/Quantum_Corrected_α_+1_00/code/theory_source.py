...
class QuantumCorrected(GravitationalTheory, QuantumMixin):
    ...
    # <reason>chain: Use larger alpha to make quantum effects clearly visible</reason>
    preferred_params = {'alpha': 1.0}  # Strong quantum correction for clear distinction from classical GR
    cacheable = True
    ...
    def get_metric(self, r: Tensor, M_param: Tensor, C_param: Tensor, G_param: Tensor, t: Tensor = None, phi: Tensor = None) -> tuple[Tensor, Tensor, Tensor, Tensor]:
        ...
        # α=0.1 means 10% correction when r=10*rs
        # NOTE: When α=0, this reduces to standard Schwarzschild metric
        quantum_term = alpha * rs_over_r  # Linear in rs/r for observable effects
        
        m = 1 - rs_over_r + quantum_term  # When α=0: m = 1 - rs/r (Schwarzschild)
